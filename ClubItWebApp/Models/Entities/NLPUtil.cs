...
namespace ClubItWebApp.Models.Entities
{
    public static class NLPUtil
    {
        ...
        /// <summary>
        /// A pre-determined list of words we'd like users to avoid entering, don't look if easily offended. The regioning will let you hide it
        /// </summary>
        static List<String> Profanity = new List<String>()
        {
            "2 girls 1 cup",
            "2g1c",
            "4r5e",
        ...
        /// <summary>
        /// Removes any applicable stems from the passed interests
        /// </summary>
        /// <param name="InterestIn"> The interest to be stemmed </param>
        ...
        /// <summary>
        /// Removes all stop words like uh, the, and, etc.
        /// </summary>
        /// <param name="InterestIn"> The interest to be filtered </param>
        ...
        /// <summary>
        /// Removes all irrelevant prepositions
        /// </summary>
        /// <param name="InterestIn"> The interest to be filtered </param>
        ...
        /// <summary>
        /// Removes all profanity listed above from the passed interest
        /// </summary>
        /// <param name="InterestIn"> The interest to have its profanity removed </param>
        public static void RemoveProfanity(UserInterest InterestIn)
        {
            int iIndex = 0;
            for (int i = 0; i < InterestIn.GetWordList().Count; i++) //Look for an occurance of a preposition
            {
                iIndex = Profanity.BinarySearch(InterestIn.GetWordList()[i].strWord);
                if (iIndex > 0)
                {
                    InterestIn.GetWordList().RemoveAt(i);      //and remove it, if found
                    i--;
        ...
        }//end RemoveProfanity(InterestIn)
        #endregion
    }
}
