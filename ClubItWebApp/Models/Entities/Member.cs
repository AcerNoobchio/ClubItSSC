...
using static ClubItWebApp.Models.Entities.EventInterest;
...
namespace ClubItWebApp.Models.Entities
{
    public class Member: IComparable<Member>, IEquatable<Member>
    {
       ...
       // private UserType Type;                    //ClubAdmin, SuperAdmin, StudentUser
        ...
        public Member(String NameIn, String ENumberIn, UserInterests InterestsIn, Events EventsIn) // User TypeIn
        {
            this.Name = NameIn;
        ...
        {
            return "Member Name: " + Name + " Email: " + Email + " Interests: " + Interests + "Event List: " + this.EventList; //" User Type: " + Type
        }
    }
}
